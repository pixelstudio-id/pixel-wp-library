...
add_filter('nav_menu_submenu_css_class', '_px_submenu_classes', 10, 3);
add_filter('wp_nav_menu', '_px_submenu_style_classes', 10);
 ...
 */
function _px_submenu_classes($classes, $args, $depth) {
 ...
 */
function _px_submenu_style_classes($menu) {
